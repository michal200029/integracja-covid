                    ...
                    <Row xs={1} md={2} className="justify-content-md-center">
                        <Col>
                            <Card className="center">
                                <Card.Img src="https://bitcoin.pl/wp-content/uploads/2020/05/litecoin-3344894_1280.jpg" alt="my image" />
                                <Card.Title>LTC</Card.Title>
                                <Card.Body>
                                    <Card.Text>Litecoin – kryptowaluta, a także otwartoźródłowy projekt na licencji X11. Zainspirowany i niemal identyczny technicznie jak bitcoin, litecoin jest tworzony i przekazywany bez udziału centralnego emitenta. Kryptowaluta została stworzona przez programistę pochodzącego z Wybrzeża Kości Słoniowej, Charliego Lee w 2011 roku. Od 2000 roku, przez prawie dekadę pracował dla Google, po czym podjął współpracę z jedną z największych giełd kryptowalut - Coinbase.</Card.Text>
                                </Card.Body>
                                <Stack>
                    ...
                    <Row xs={1} md={2} className="justify-content-md-center">
                        ...
                        <Col>
                            <Card className="center">
                                ...
                                <Card.Body>
                                    <LineChart width={600} height={300} data={values} margin={{ top: 5, right: 20, bottom: 5, left: 0 }}>
