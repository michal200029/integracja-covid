                    ...
                    <Row xs={1} md={2} className="justify-content-md-center">
                        <Col>
                            <Card className="center">
                                <Card.Img src="https://gagadget.com/media/post_big/Ethereum.jpg" alt="my image" />
                                <Card.Title>ETH</Card.Title>
                                <Card.Body>
                                    <Card.Text>Ethereum – zdecentralizowana platforma o otwartym oprogramowaniu, zbudowana na technologii blockchain i obsługująca znane pod nazwą smart contract kontrakty peer-to-peer oraz zdecentralizowane aplikacje (dapps). Jej natywną kryptowalutą jest Ether (ETH), umożliwiający przeprowadzanie transakcji między użytkownikami bądź aplikacjami i uiszczania powiązanych z nimi opłat, wynikających z potrzebnej do ich przetworzenia mocy obliczeniowej.</Card.Text>
                                </Card.Body>
                                <Stack>
