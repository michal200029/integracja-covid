            ...
            return (
                <>
                    ...
                    <Row xs={1} md={2} className="justify-content-md-center">
                        <Col>
                            <Card className="center">
                                <Card.Img src="https://ocdn.eu/pulscms-transforms/1/f7MktkuTURBXy9jODlhNWE0Ni0yY2NjLTQ0MjMtYWExNS0zMjRlNzU0YWMyMzQuanBlZ5GTBc0EsM0CdA" alt="my image" />
                                <Card.Title>USD</Card.Title>
                                <Card.Body>
                                    <Card.Text>Dolar amerykański (oficjalna nazwa – United States dollar, międzynarodowy skrót – USD) – oficjalna waluta Stanów Zjednoczonych, Portoryko, Mikronezji, Marianów Północnych, Palau, Wysp Marshalla, Panamy, Ekwadoru (od 2000), Salwadoru (od 2001), Timoru Wschodniego, Zimbabwe (od 2009), Turks i Caicos, Bonaire, Saby i Sint Eustatius od 2011 roku. Jeden dolar amerykański dzieli się na sto centów amerykańskich. Zapisuje się go za pomocą symbolu $.</Card.Text>
                                </Card.Body>
                                <Stack>
                    ...
                    <Row xs={1} md={2} className="justify-content-md-center">
                        ...
                        <Col>
                            <Card className="center">
                                <Card.Title>Wykres przedstawiający </Card.Title>
                                <Card.Body>
                    ...
                    <Row xs={1} md={2} className="justify-content-md-center">
                        <Col>
                            <Card className="center">
                                <Card.Title>Tabela przedstawiająca </Card.Title>
                                <Card.Body>
