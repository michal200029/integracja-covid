...
export class Gbp extends Component {
    constructor(props) {
        super(props);
        this.state = {
                    ...
                    <Row xs={1} md={2} className="justify-content-md-center">
                        <Col>
                            <Card className="center">
                                <Card.Img src="https://thumbs.dreamstime.com/z/british-pound-queen-elizabeth-medical-mask-coronovirus-covid-pandemic-concept-world-financial-crisis-economy-176045755.jpg" alt="my image" />
                                <Card.Title>GBP</Card.Title>
                                <Card.Body>
                                    <Card.Text>Funt szterling (ang. pound sterling, £), nieoficjalna nazwa funt brytyjski, kod międzynarodowy GBP – oficjalna jednostka monetarna w Wielkiej Brytanii. 1 funt dzieli się na 100 pensów. W obiegu znajdują się monety o nominałach 1p, 2p, 5p, 10p, 20p, 50p, £1, £2 oraz banknoty £5, £10, £20, £50, £100 (tylko w Szkocji i Irlandii Północnej).</Card.Text>
                                </Card.Body>
                                <Stack>
