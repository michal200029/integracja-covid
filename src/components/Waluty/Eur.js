...
export class Eur extends Component {
    constructor(props) {
        super(props);
        this.state = {
                    ...
                    <Row xs={1} md={2} className="justify-content-md-center">
                        <Col>
                            <Card className="center">
                                <Card.Img src="https://img.freepik.com/darmowe-zdjecie/pieniadze-w-euro-monety-i-modele-wirusa-covid-19-zanieczyszczone-zainfekowane-pieniadze-kryzys-gospodarczy_165623-273.jpg" alt="my image" />
                                <Card.Title>EUR</Card.Title>
                                <Card.Body>
                                    <Card.Text>Euro (znak: €, kod ISO 4217: EUR; bułg. евро, trb. ewro; gr. ευρώ; łot. eiro; lit. euras; malt. ewro; słoweń. evro; węg. euró) – nazwa waluty wprowadzonej w większości państw Unii Europejskiej, a także innych, w miejsce walut krajowych. W formie gotówkowej walutę euro wprowadzono do obiegu dnia 1 stycznia 2002 roku. Euro jest prawnym środkiem płatniczym w 19 państwach tworzących w Unii Europejskiej strefę euro a obejmującą swym obszarem około 341 mln[10] Europejczyków.</Card.Text>
                                </Card.Body>
                                <Stack>
                                            ...
                                            <TableBody>
                                                {
                                                    values.map(d => (
                                                        ...
                                                        >
                                                            ...
                                                            <TableCell align="center">{d.rate.toFixed(4)}</TableCell>
                                                        </TableRow>
                                                    )
                                                    )
                                                }
                                        ...
                                        <Table sx={{ minWidth: 700 }} aria-label="spanning table">
                                            ...
                                            <TableBody>
                                                ...
                                                <StyledTableRow>
                                                    ...
                                                    <TableCell align="center">{feb.rate.toFixed(4)}</TableCell>
                                                    <TableCell align="center">{apr.rate.toFixed(4)}</TableCell>
                                                </StyledTableRow>
                                                <TableRow>
                                                    <TableCell rowSpan={3} />
