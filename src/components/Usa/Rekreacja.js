...
export class Rekre extends Component {
    constructor(props) {
        super(props);
        this.state = {
    ...
    componentDidMount(){
        ...
        axios.post(`http://localhost:8080/usa/leisure`,{
                    ...
                    <Row xs={1} md={2} className="justify-content-md-center">
                        <Col>
                            <Card className="center">
                                <Card.Img src="https://www.lifeandmore.pl/files/Image/amerykanie.jpg" />
                                <Card.Title>Rekreacja w USA</Card.Title>
                                <Card.Body>
                                    <Card.Text>Baseball, koszykówka, futbol amerykański i hokej na lodzie są najpopularniejszymi sportami widzów i uczestnikami, ale Amerykanie cieszą się olbrzymim spektrum działań, w tym piłka nożna, jazda na rowerze, rakieta (hybryda squasha i piłki ręcznej), tenis, pływanie, golf kręgle, sztuki walki, spacery, jogging i ćwiczenia aerobowe. Szkoły, miasta i inne organizacje sponsorują sport zespołowy dla młodzieży, a sport zawodowy jest ważną częścią kultury. Ogólnie rzecz biorąc, większość Amerykanów spędza dużo czasu wolnego na spotkaniach towarzyskich lub oglądaniu telewizji. Inne zajęcia rekreacyjne to chodzenie do kina lub koncertów, pikniki i podróże. </Card.Text>
                                </Card.Body>
                                <Stack>
