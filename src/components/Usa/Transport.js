...
export class Trans extends Component {
    ...
    componentDidMount(){
        ...
        axios.post(`http://localhost:8080/usa/transportation`,{
                    ...
                    <Row xs={1} md={2} className="justify-content-md-center">
                        ...
                        <Col>
                            <Card className="center">
                                ...
                                <Card.Body>
                                    <LineChart width={600} height={300} data={values} margin={{ top: 5, right: 20, bottom: 5, left: 20 }}>
                                        <Line type="monotone" dataKey="employees" stroke="#8884d8" />
                                        <CartesianGrid stroke="#ccc" strokeDasharray="5 5" />
                                        <XAxis dataKey="date" />
                                        <YAxis domain={[22000000,30000000]}/>
                                        <Tooltip />
                                    </LineChart>
                                </Card.Body>
                            </Card><br />
